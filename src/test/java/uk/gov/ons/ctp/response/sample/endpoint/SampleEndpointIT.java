...
public class SampleEndpointIT {
  ...
  @Test
  public void shouldPutSampleIdAndAttributesOnQueueWhenSampleUnitsRequested() throws UnirestException, InterruptedException, JAXBException {
    // Given
    final String sampleFile = "/csv/social-survey-sample.csv";
    ...
    CollectionExerciseJobCreationRequestDTO collexJobRequest = new CollectionExerciseJobCreationRequestDTO(
            UUID.randomUUID(), "TEST", new Date(), Collections.singletonList(sampleSummaryResponse.getBody()
                                                                                                  .getId()));
    ...
    assertThat(sampleUnit.getSampleAttributes()
                         .getEntries()).contains(
  ...
  @Test
  public void ensureAttributesReturnedWhenGettingSample() throws UnirestException, IOException, InterruptedException {
