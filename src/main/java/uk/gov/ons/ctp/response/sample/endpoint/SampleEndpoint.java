...
public final class SampleEndpoint extends CsvToBean<BusinessSampleUnit> {
  ...
  @Autowired
  public SampleEndpoint(SampleService sampleService, MapperFacade mapperFacade, SampleUnitDistributor distributor) {
   ...
   * exerciseDateTime
   *
   * @param collectionExerciseJobCreationRequestDTO CollectionExerciseJobCreationRequestDTO
   *                                                related to SampleUnits
   * @param bindingResult                           collects errors thrown
   * @return Response Returns sampleUnitsTotal value
   * @throws CTPException            if update operation fails or
   *                                 CollectionExerciseJob already exists
  ...
  public ResponseEntity<SampleUnitsRequestDTO> createSampleUnitRequest(
    ...
    log.debug("Entering createCollectionExerciseJob ",
    ...
    String newResourceUrl = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}")
  ...
  public ResponseEntity<SampleSummaryDTO> findSampleSummary(@PathVariable("sampleSummaryId") final UUID sampleSummaryId)
      throws CTPException {
  ...
  public ResponseEntity<SampleUnitDTO> requestSampleUnit(@PathVariable("id") final UUID sampleUnitId)
      throws CTPException {
