...
import uk.gov.ons.ctp.response.libs.common.state.BasicStateTransitionManager;
...
/**
 * This is the state transition manager factory for the samplesvc. It intended that this will be
